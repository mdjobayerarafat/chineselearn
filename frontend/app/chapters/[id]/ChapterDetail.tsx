...
import { ArrowLeft, Image as ImageIcon, Loader2, ChevronLeft, ChevronRight, LayoutGrid, SquareStack, ArrowRightLeft, MessageSquare, BookOpen } from "lucide-react";
import { motion } from "framer-motion";
import DialogueLearning from "./DialogueLearning";
...
export default function ChapterDetail({ id }: ChapterDetailProps) {
  ...
  // Keyboard navigation
  useEffect(() => {
    if (viewMode !== 'study' || activeTab !== 'vocabulary') return;
  ...
  }, [viewMode, activeTab, handleNext, handlePrev]);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            {/* Tab Switcher */}
            <div className="bg-white dark:bg-zinc-800 p-1.5 rounded-xl border border-gray-200 dark:border-zinc-700 shadow-sm flex items-center">
              <button
            ...
            {activeTab === 'vocabulary' && viewMode === 'study' && (
